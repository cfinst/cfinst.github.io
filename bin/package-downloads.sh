...
# Note that this directory itself will be included
# in the .zip file, so the name does matter.
DOWNLOAD_DIR=cfi-laws-database_Disclosure
...
#__________________________
# RUN AGAIN FOR PUBLIC FINANCING FILE
#__________________________
...
# Note that this directory itself will be included
# in the .zip file, so the name does matter.
DOWNLOAD_DIR=cfi-laws-database_PublicFinancing
...
# Note that this directory itself will be included
# in the .zip file, so the name does matter.
DOWNLOAD_DIR=cfi-laws-database_Other
